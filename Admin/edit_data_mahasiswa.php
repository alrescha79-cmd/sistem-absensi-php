  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Edit Data Mahasiswa</div>
        </div>
        <div class="container">
            <div class="container">
    ...
    <hr>
      ...
      <?php
          ...
          $sql = mysqli_query($conn, "SELECT * FROM mahasiswa WHERE nim='".$id_mahasiswa."'");
  ...
  <form action="proses-edit-mahasiswa.php" method="POST" >
    <div class="row">
        <div class="col-md-4">
          ...
          <label>NIM</label>
          <input type="text" class="form-control" name="nim" placeholder="NIM"  value="<?php echo
          $hasil['nim']; ?>" readonly>
        </div>
        <div class="form-group">
          <label>Nama Mahasiswa</label>
          <input type="text" class="form-control" name="nama_mahasiswa" placeholder="Nama Mahasiswa" value="<?php echo
          $hasil['nama']; ?>" >
        </div>
        <div class="form-group">
