  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i>Edit Data Dosen</div>
        </div>
        <div class="container">
          <div class="container">
    ...
    <hr>
      ...
      <?php
          ...
          $nidn = $_GET['edit'];
          $sql = mysqli_query($conn, "SELECT * FROM dosen WHERE nidn='".$nidn."'");
    ...
    <div class="row">
      <div class="col-sm-4">
        <div class="form-group">
          <label>NIDN</label>
          <input type="text" class="form-control" name="nidn" placeholder="NIDN" style="width: 250px" value="<?php
          echo $hasil['nidn']; ?>" readonly>
        </div>
        <div class="form-group">
          <label>Nama Dosen</label>
          <input type="text" class="form-control" name="nama_dosen" placeholder="Nama Dosen" style="width: 250px"
                 value="<?php echo $hasil['nama_dosen']; ?>">
        </div>
        <div class="form-group">
          <label>Alamat</label>
