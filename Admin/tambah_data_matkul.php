...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Tambah Data Mata Kuliah</div>
        </div>
        <div class="container">
            <div class="container">
    ...
    <hr>
      <br>
  <form action="proses-tambah-matkul.php" method="POST" >
    <div class="row">
        <div class="col-sm-3">

        <div class="form-group">
          <label>Nama Mata Kuliah</label>
          <input type="text" class="form-control" name="matkul" placeholder="Nama Mata Kuliah" style="width: 250px" >
          <br>
          <input type="submit" name="submit" value="Simpan" class="btn btn-success">
          <a href="data_mata_kuliah.php"><input type="button" class="btn btn-default" value="Batal" ></a>
        </div>
