  ...
  <form action="proses-tambah-mahasiswa.php" method="POST" >
    <div class="row">
        <div class="col-sm-3">
          ...
          <label>NIM</label>
          <input type="text" class="form-control" name="nim" placeholder="NIM" style="width: 250px" >
        </div>
        <div class="form-group">
          <label>Nama Mahasiswa</label>
          <input type="text" class="form-control" name="nama_mahasiswa" placeholder="Nama Mahasiswa" style="width:
          250px" >
        </div>
        <div class="form-group">
          <label>Jenis Kelamin</label>
<!--          <input type="text" class="form-control" name="jenis_kelamin" placeholder="Jenis Kelamin" style="width: 250px" >-->
<!--            input diganti dengan pilihan laki-laki atau perempuan-->
            <select class="form-control" name="jenis_kelamin" style="width: 250px">
      ...
      <a href="data_mahasiswa.php"><input type="button" class="btn btn-default" value="Batal" ></a>
        </div>
        </div>
    </div>
      </form>
