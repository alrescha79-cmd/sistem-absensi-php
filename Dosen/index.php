...
<!--      jumbotron-->
      <div class="">
        <div class="jumbotron">
            ...
            while ($hasil = mysqli_fetch_array($sql)) {
                ?>
            <h1 class="text-center" style="text-align: center; padding-bottom: 20px; color: white;">SELAMAT DATANG
                <span class="font-weight-bold text-secondary bg-light px-2 rounded"><?php echo
                    $hasil['nama_dosen']; }?></span>
                 </h1>
        ...
        <div class="row">
            <div class="col-xl-3 col-sm-6 mb-3">
                <div class="card text-white bg-primary o-hidden h-100">
                    <div class="card-body">
                        ...
                        <div class="mr-5">Input Absensi</div>
                    </div>
                    <a class="card-footer text-white clearfix small z-1" href="data_absensi.php">
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
                <div class="card text-white bg-warning o-hidden h-100">
                    ...
                    <a class="card-footer text-white clearfix small z-1" href="tampil_data_absensi.php">
                        <span class="float-left">View Details</span>
                        <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
                ...
                <div class="card text-white bg-success o-hidden h-100">
                    <div class="card-body">
                        ...
                        <div class="mr-5">Presentase Kehadiran</div>
                    </div>
                    <a class="card-footer text-white clearfix small z-1" href="rekap-absensi.php">
                        <span class="float-left">View Details</span>
                        <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
